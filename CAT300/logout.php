                            ...
                            <div class="tab-pane active" id="Login">
                                ...
                                <div class="form-group">
                                    <label for="email" class="col-sm-3 control-label">
                                        UserName</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="username" id="email1" placeholder="UserName" />
                                    </div>
                                </div>
                                <div class="form-group">
...
<div class="global-navbar navbar navbar-default" role="navigation">
         ...
         <h1 class="section-title" align=center>
              	<font face="Arial, Helvetica, sans-serif" size="+2">~You have been logged out. <a href="index.php">Start Again</a>~ </font></h1>
