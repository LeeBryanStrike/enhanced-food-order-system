...
if(isset($_SESSION["order_id"]))
	...
	<div class="tab-content">			
           <div id="products" class="tab-pane fade in active ">
				...
				WHERE tbl_order_details.product_status = "served" AND 
                tbl_product.type = "food" ORDER BY `tbl_order_details`.`id` DESC
				';
...
<!-- beverage -->
 <div id="beverage" class="tab-pane fade  ">
                ...
                on tbl_product.name = tbl_order_details.product_name
				WHERE tbl_order_details.product_status = "served" AND 
                tbl_product.type = "drink" ORDER BY `tbl_order_details`.`id` DESC
				';
				$result = mysqli_query($connect, $query);
				while($row = mysqli_fetch_array($result))
				{			
...
<!-- sidedish -->
 <div id="sidedish" class="tab-pane fade  ">
                ...
                on tbl_product.name = tbl_order_details.product_name
				WHERE tbl_order_details.product_status = "served" AND 
                tbl_product.type = "side" ORDER BY `tbl_order_details`.`id` DESC
				';
				$result = mysqli_query($connect, $query);
				while($row = mysqli_fetch_array($result))
				{			
